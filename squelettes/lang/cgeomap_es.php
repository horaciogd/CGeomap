...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'module_help_text' => 'Haz clic 2 veces para escribir un título diferente para tu bloque de texto. Cada bloque puede contener hasta un máximo de 500 caracteres sin estilo.',
	'module_help_link' => 'Haz clic 2 veces para escribir un título diferente a tu listado de enlaces. Puedes añadir hasta 15 direcciones de internet. Cuidado, no debes apretar la tecla \'enter\' para terminar la edición de los textos. Haz clic fuera del bloque para seguir editando otros contenidos.',
	'module_help_image' => 'Haz clic 2 veces para escribir un título diferente para la descripción de la imagen. Subir una imagen en formato JPG o PNG con una dimensión máxima de 2048X1536 pixeles.',
	'module_help_sound' => 'Haz clic 2 veces para escribir un título diferente para la descripción del audio. Subir un mp3 con una duración máxima de 7 minutos.',
